...
export default function Login() {
  ...
  <title></title>
    ...
    <div>
      <h2 className='mt-32 text-xl  '>{text.signIn} :</h2>
      ...
      <p className='text-center py-5'>{text.registerMS}<Link to={'/register'} className='text-green-700 font-bold underline'>
      {text.registerNow}</Link> </p>
      <p className='text-center pb-5'><Link to={'/forget'} className='text-green-700 font-bold underline'>
      {text.forgetPassword}</Link> </p>
